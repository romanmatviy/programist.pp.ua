        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {[
              ...
              { href: 'https://indexfast.pro', icon: '🚀', name: 'IndexFast.pro', desc: lang === 'ua' ? 'Швидка індексація сторінок у Google' : 'Быстрая индексация страниц в Google', linkText: lang === 'ua' ? 'Індексація сайту в Google' : 'Индексация сайта в Google' },
